...
describe('Version Comparison Tests for isVersionGreaterOrEqual', () => {
  test('should log deprecation warning when bridge version is greater than or equal to source upload unsupported version', async () => {
    Object.defineProperty(inputs, 'POLARIS_SERVER_URL', {value: 'server_url'})
    Object.defineProperty(inputs, 'POLARIS_ACCESS_TOKEN', {value: 'access_token'})
    Object.defineProperty(inputs, 'POLARIS_APPLICATION_NAME', {value: 'POLARIS_APPLICATION_NAME'})
    Object.defineProperty(inputs, 'POLARIS_PROJECT_NAME', {value: 'POLARIS_PROJECT_NAME'})
    Object.defineProperty(inputs, 'BRIDGE_CLI_DOWNLOAD_VERSION', {value: '3.8.0'})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_TYPES', {value: 'SCA,sast'})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_MODE', {value: 'SOURCE_UPLOAD'}) // Deprecated parameter

    jest.spyOn(Bridge.prototype, 'validateBridgeVersion').mockResolvedValueOnce(true)
    // Mock bridge version to be 3.8.0 (greater than or equal to 3.7.8)
    jest.spyOn(fs, 'readFileSync').mockReturnValueOnce('bridge-cli-bundle: 3.8.0')
    const downloadFileResp: DownloadFileResponse = {
      filePath: 'C://user/temp/download/',
      fileName: 'C://user/temp/download/bridge-win.zip'
    }
    ...
    expect(infoSpy).toHaveBeenCalledWith('polaris_assessment_mode is deprecated. Use polaris_test_sast_location=remote and/or polaris_test_sca_location=remote for source upload scans instead.')

    Object.defineProperty(inputs, 'POLARIS_SERVER_URL', {value: null})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_MODE', {value: null})
  })

  test('should not log deprecation warning when bridge version is less than source upload unsupported version', async () => {
    Object.defineProperty(inputs, 'POLARIS_SERVER_URL', {value: 'server_url'})
    Object.defineProperty(inputs, 'POLARIS_ACCESS_TOKEN', {value: 'access_token'})
    Object.defineProperty(inputs, 'POLARIS_APPLICATION_NAME', {value: 'POLARIS_APPLICATION_NAME'})
    Object.defineProperty(inputs, 'POLARIS_PROJECT_NAME', {value: 'POLARIS_PROJECT_NAME'})
    Object.defineProperty(inputs, 'BRIDGE_CLI_DOWNLOAD_VERSION', {value: '2.0.0'})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_TYPES', {value: 'SCA,sast'})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_MODE', {value: 'SOURCE_UPLOAD'}) // Deprecated parameter

    jest.spyOn(Bridge.prototype, 'validateBridgeVersion').mockResolvedValueOnce(true)
    // Mock bridge version to be 2.0.0 (less than 3.5.0)
    jest.spyOn(fs, 'readFileSync').mockReturnValueOnce('bridge-cli-bundle: 2.0.0')
    const downloadFileResp: DownloadFileResponse = {
      filePath: 'C://user/temp/download/',
      fileName: 'C://user/temp/download/bridge-win.zip'
    }
    ...
    const response = await run()
    expect(response).toEqual(0)
    // Verify that deprecation warning was NOT logged
    expect(infoSpy).not.toHaveBeenCalledWith('polaris_assessment_mode is deprecated. Use polaris_test_sast_location=remote and/or polaris_test_sca_location=remote for source upload scans instead.')

    Object.defineProperty(inputs, 'POLARIS_SERVER_URL', {value: null})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_MODE', {value: null})
  })

  test('should not log deprecation warning when polaris_assessment_mode is not set', async () => {
    Object.defineProperty(inputs, 'POLARIS_SERVER_URL', {value: 'server_url'})
    Object.defineProperty(inputs, 'POLARIS_ACCESS_TOKEN', {value: 'access_token'})
    Object.defineProperty(inputs, 'POLARIS_APPLICATION_NAME', {value: 'POLARIS_APPLICATION_NAME'})
    Object.defineProperty(inputs, 'POLARIS_PROJECT_NAME', {value: 'POLARIS_PROJECT_NAME'})
    Object.defineProperty(inputs, 'BRIDGE_CLI_DOWNLOAD_VERSION', {value: '3.5.0'})
    Object.defineProperty(inputs, 'POLARIS_ASSESSMENT_TYPES', {value: 'SCA,sast'})
    // POLARIS_ASSESSMENT_MODE is not set

    jest.spyOn(Bridge.prototype, 'validateBridgeVersion').mockResolvedValueOnce(true)
    // Mock bridge version to be 3.5.0 (greater than or equal to 3.5.0)
    jest.spyOn(fs, 'readFileSync').mockReturnValueOnce('bridge-cli-bundle: 3.5.0')
    const downloadFileResp: DownloadFileResponse = {
      filePath: 'C://user/temp/download/',
      fileName: 'C://user/temp/download/bridge-win.zip'
    }
    ...
    const response = await run()
    expect(response).toEqual(0)
    // Verify that deprecation warning was NOT logged because POLARIS_ASSESSMENT_MODE is not set
    expect(infoSpy).not.toHaveBeenCalledWith('polaris_assessment_mode is deprecated. Use polaris_test_sast_location=remote and/or polaris_test_sca_location=remote for source upload scans instead.')
