...
export const POLARIS_EXTERNALISSUES_GROUPSCAISSUES = getInput(constants.POLARIS_EXTERNALISSUES_CREATE)?.trim().toLowerCase() === 'true' || true
...
// GitHub Issues Parameters for Polaris
export const BLACKDUCKSCA_EXTERNALISSUES_CREATE = getInput(constants.BLACKDUCKSCA_EXTERNALISSUES_CREATE)?.trim().toLowerCase() === 'true' || false
export const BLACKDUCKSCA_EXTERNALISSUES_SEVERITIES = getInput(constants.BLACKDUCKSCA_EXTERNALISSUES_SEVERITIES)?.trim() || ''
export const BLACKDUCKSCA_EXTERNALISSUES_TYPES = getInput(constants.BLACKDUCKSCA_EXTERNALISSUES_TYPES)?.trim() || ''
export const BLACKDUCKSCA_EXTERNALISSUES_GROUPSCAISSUES = getInput(constants.BLACKDUCKSCA_EXTERNALISSUES_GROUPSCAISSUES)?.trim().toLowerCase() === 'true' || false
export const BLACKDUCKSCA_EXTERNALISSUES_MAXCOUNT = getInput(constants.BLACKDUCKSCA_EXTERNALISSUES_MAXCOUNT)?.trim() || ''
