...
export function isGitHubCloud(): boolean {
  ...
  info(`GitHub Server URL: ${constants.GITHUB_DATA_RESIDENCY_SERVER_URL_PATTERN.test(githubServerUrl)}`)
  info(`GitHub Server URL: ${githubServerUrl === constants.GITHUB_CLOUD_URL}`)
